...
_STYLE = (
    ...
    ".change-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px;margin-top:12px}"
    ...
    ".change-card.change-first{border-left-color:var(--teal)}"
    ...
    ".change-detail{margin:0;color:var(--ink);font-size:.86rem}"
    ".change-chips{display:flex;flex-wrap:wrap;gap:6px}"
    ".change-chip{display:inline-block;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"
    "padding:3px 8px;border:1px solid var(--line);border-radius:999px;background:var(--surface-muted);"
    "color:var(--muted);font-size:.72rem}"
    ".change-card.change-new{grid-column:1/-1;gap:12px;padding:20px;border-left-color:var(--teal);background:var(--mint)}"
    ".change-card.change-new .change-badge{color:var(--teal);font-size:.72rem}"
    ".change-card.change-new .change-count{min-width:30px;height:30px;padding:0 9px;border-radius:9px;"
    "background:var(--teal);color:var(--on-accent);font-size:.9rem}"
    ".change-card.change-new .change-detail{font-size:1rem;font-weight:700;letter-spacing:-.01em}"
    ".change-card.change-new .change-chip{padding:4px 10px;border-color:var(--link-border);background:var(--link-bg);"
